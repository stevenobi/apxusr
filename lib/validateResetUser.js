...
var buttonID = "#RESETP"; //static ID of button to set enabled state on
var checkField = "RNUPW"; // field to validate
...
var regRegion = "#R23603729286173019";
var successRegion = "#R20069435705195293";
var errorRegion = "#R20073796735197722";
...
// ReRegister Button
var reRegButton = '#USR_RESET_SUB_BUTTONS > div > div > div:nth-child(2)';
...
form.on("keyup keydown keypress", function(e) {
    ...
    if (keyCode === 13 || keyCode === 9) {
        ...
        keyCode === 13 ? (e.preventDefault() && checkInput() && setReRegButton(userStatus)) : null;
        checkInput();
