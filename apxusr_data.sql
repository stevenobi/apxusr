...
VALUES ('ON', 'ON', (SELECT APP_SCOPE_ID from APX$APP_SCOPE WHERE APP_SCOPE = 'SETTING'), v('FB_FLOW_ID'));
insert into "APX$APP_STATUS" (APP_STATUS, APP_STATUS_CODE, APP_STATUS_SCOPE_ID, APP_ID)
values ('OFF', 'OFF', (SELECT APP_SCOPE_ID from APX$APP_SCOPE WHERE APP_SCOPE = 'SETTING'), V('FB_FLOW_ID'));
insert into "APX$APP_STATUS" (APP_STATUS, APP_STATUS_CODE, APP_STATUS_SCOPE_ID, APP_ID)
VALUES ('ENABLED', 'ENA', (SELECT APP_SCOPE_ID from APX$APP_SCOPE WHERE APP_SCOPE = 'APP_SETTING'), v('FB_FLOW_ID'));
insert into "APX$APP_STATUS" (APP_STATUS, APP_STATUS_CODE, APP_STATUS_SCOPE_ID, APP_ID)
values ('DISABLED', 'DIS', (SELECT APP_SCOPE_ID from APX$APP_SCOPE WHERE APP_SCOPE = 'APP_SETTING'), V('FB_FLOW_ID'));
insert into "APX$APP_STATUS" (APP_STATUS, APP_STATUS_CODE, APP_STATUS_SCOPE_ID, APP_ID)
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
-- INSERTING into "APX$APP_SETTINGS"
Insert into APX$APP_SETTINGS (APP_SETTING_ID,APP_SETTING_NAME,APP_SETTING_VALUE,APP_SETTING_DEF_VALUE,APP_SETTING_STATUS_ID,APP_SETTING_SCOPE_ID,APP_SETTING_DESCRIPTION,APP_SETTING_COMMENT,APP_SETTING_CATEGORY,APP_ID)
values ('0','DEFAULT',null,null,'0','0','Default Setting','The Default Value','ALL',v('FB_FLOW_ID'));
Insert into APX$APP_SETTINGS (APP_SETTING_ID,APP_SETTING_NAME,APP_SETTING_VALUE,APP_SETTING_DEF_VALUE,APP_SETTING_STATUS_ID,APP_SETTING_SCOPE_ID,APP_SETTING_DESCRIPTION,APP_SETTING_COMMENT,APP_SETTING_CATEGORY,APP_ID)
values ('1','USERNAME_FORMAT','EMAIL','EMAIL','11','-10','User Login Format (EMAIL | USERNAME)',null,'AUTHENTICATION',v('FB_FLOW_ID'));
Insert into APX$APP_SETTINGS (APP_SETTING_ID,APP_SETTING_NAME,APP_SETTING_VALUE,APP_SETTING_DEF_VALUE,APP_SETTING_STATUS_ID,APP_SETTING_SCOPE_ID,APP_SETTING_DESCRIPTION,APP_SETTING_COMMENT,APP_SETTING_CATEGORY,APP_ID)
values ('10','AUTHENTICATION_METHOD','TWO_FACTOR',null,'11','-10','Authetication Method of APEX Application',null,'AUTHENTICATION',v('FB_FLOW_ID'));
